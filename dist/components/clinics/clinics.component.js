System.register(['angular2/core', 'angular2/http', 'rxjs/add/operator/map', '../clinic/clinic.component'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, http_1, clinic_component_1;
        ...
        execute: function() {
            ClinicsComponent = (function () {
                ...
                ClinicsComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.http.get(this.clinicsUrl).map(function (res) { return res.json(); }).subscribe(function (data) { _this.clinics = data; });
                };
